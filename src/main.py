...
class PipelineOrchestrator:
    ...
    def ejecutarIngesta(self):
        ...
        Cohesiona la descarga de datos externos y delega su persistencia física en Storage.
        """
    ...
    def ejecutarLimpieza(self, df_bronze):
        ...
        Delega la conversión estructural y el formateo de IDs al componente experto.
        """
    ...
    def ejecutarPipeline(self):
        ...
        try:
            ...
            # Ejecución de sub-procesos con alta cohesión (Trazabilidad estricta con C.U.)
            ...
            # Finalización y auditoría exitosa
